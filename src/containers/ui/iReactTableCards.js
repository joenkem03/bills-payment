...
function Table({ columns, data, divided = false, defaultPageSize = 10, fetchData, pageCount: controlledPageCount,
  ...
  return (
    <>
      <table 
        {...getTableProps()}
        className={`r-table table ${classnames({ 'table-hover': true, 'table-responsive': true, 'table-divided': divided,  })}`}
      >
        <thead>
    ...
    <div className="mb-4">
      <Card>
        <CardBody>
          ...
          >
            <Table columns={cols} data={data} fetchData={fetchData} divided 
  // showPageSizeOptions = true,
  // showPageJump = false,
