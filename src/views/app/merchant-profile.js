...
import {MakeId, getCurrentUser, setCurrentUser} from 'helpers/Utils';
...
const MerchantProfile = ({ merchant }) => {
  ...
  return (
    <>
      ...
      {currentMerchant.role === UserRole.Merchant && !currentMerchant.isComplete &&
        <>
          {!merchant.casStatus &&
          <Row className="mb-4">
            <Colxx xxs="8" className="container-fluid">
              <Card>
                <CardBody>
                  <CardTitle>
