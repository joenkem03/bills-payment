...
import {GetAdminUsers, NewSubAccount} from 'services/ProtectedService';
import AlertNotice from 'components/common/alert';
import StatusAction from 'components/common/authActionStatus';
import { UserRole } from '../../constants/defaultValues';
import { getCurrentUser } from '../../helpers/Utils';

const AdminUserList = ({ match }) => {
  ...
  const isShowAdd = currentRole === UserRole.Admin;
...
const registerScheme = Yup.object().shape({
  ...
  return (
    <>
      <Row>
        <Colxx xxs="12">
          <Breadcrumb heading="menu.admins" match={match} />
...
{/* 
        ...
        <Colxx xxs="12">
          ...
          fetchService={GetAdminUsers} 
          fieldList={fieldData}
          handleAddNew={handleAddNew}
          pagetitle={<><IntlMessages id="menu.admins" /> List</>} />{' '}
        </Colxx>
      </Row>
